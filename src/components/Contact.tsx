    ...
    <section id="contact" className="section-padding bg-white">
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          <div className="bg-white rounded-xl shadow-xl p-6 md:p-8 border border-marble-200">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    onChange={handleChange}
                    className="bg-marble-50 min-h-[120px]"
                    required
                  />
                </div>
                
                <Button type="submit" className="elle-button w-full flex items-center gap-2">
