    ...
    <section id="contact" className="section-padding bg-white">
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          <div>
            <div className="bg-elle-500 text-white rounded-xl shadow-xl p-6 md:p-8 h-full relative overflow-hidden transform transition-all duration-500 hover:shadow-2xl hover:-translate-y-1">
              {/* Changed to display image without opacity overlay, positioned differently */}
              <div className="absolute left-0 top-0 w-full h-full">
                <div className="relative h-full">
                  <img 
                    src="/lovable-uploads/497b326b-e760-4f4f-8a33-f41958bcff52.png" 
                    alt="עמית דניאל" 
                    className="absolute top-[-2rem] right-[-5rem] h-64 w-auto object-cover rounded-full shadow-2xl border-4 border-white/20 rotate-12 animate-pulse"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-elle-500 via-elle-500/90 to-elle-500/70"></div>
                </div>
              </div>
